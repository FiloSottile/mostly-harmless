...
func filippoIO(mux *http.ServeMux) {
	...
	handleFuncWithCounter(mux, "geomys.org/fips140", func(rw http.ResponseWriter, r *http.Request) {
		rw.Header().Set("Content-Type", "text/html; charset=UTF-8")
	...
	mux.Handle("filippo.io/torchwood/", goGetHandler{
		Name:     "torchwood",
		Redirect: "https://pkg.go.dev/filippo.io/torchwood",
	})
